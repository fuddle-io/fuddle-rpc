...
type ClientMemberUpdateType int32

const (
	ClientMemberUpdateType_REGISTER   ClientMemberUpdateType = 0
	ClientMemberUpdateType_UNREGISTER ClientMemberUpdateType = 1
	ClientMemberUpdateType_HEARTBEAT  ClientMemberUpdateType = 2
)

// Enum value maps for ClientMemberUpdateType.
var (
	ClientMemberUpdateType_name = map[int32]string{
		0: "REGISTER",
		1: "UNREGISTER",
		2: "HEARTBEAT",
	}
	ClientMemberUpdateType_value = map[string]int32{
		"REGISTER":   0,
		"UNREGISTER": 1,
		"HEARTBEAT":  2,
	}
...
func (x ClientMemberUpdateType) Enum() *ClientMemberUpdateType {
	p := new(ClientMemberUpdateType)
	*p = x
	return p
}

func (x ClientMemberUpdateType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ClientMemberUpdateType) Descriptor() protoreflect.EnumDescriptor {
	return file_registryv2_proto_enumTypes[1].Descriptor()
}

func (ClientMemberUpdateType) Type() protoreflect.EnumType {
	return &file_registryv2_proto_enumTypes[1]
}

func (x ClientMemberUpdateType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ClientMemberUpdateType.Descriptor instead.
func (ClientMemberUpdateType) EnumDescriptor() ([]byte, []int) {
...
type ClientMemberUpdate struct {
	...
	UpdateType ClientMemberUpdateType `protobuf:"varint,1,opt,name=update_type,json=updateType,proto3,enum=registryv2.ClientMemberUpdateType" json:"update_type,omitempty"`
	Member     *Member2               `protobuf:"bytes,2,opt,name=member,proto3,oneof" json:"member,omitempty"`
}
...
func (x *ClientMemberUpdate) GetUpdateType() ClientMemberUpdateType {
	if x != nil {
		return x.UpdateType
	}
	return ClientMemberUpdateType_REGISTER
}

func (x *ClientMemberUpdate) GetMember() *Member2 {
	if x != nil {
		return x.Member
	}
	return nil
...
var file_registryv2_proto_rawDesc = []byte{
	...
	0x22, 0x96, 0x01, 0x0a, 0x12, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x6d, 0x62, 0x65,
	0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x43, 0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x72,
	...
	,
...
var file_registryv2_proto_goTypes = []interface{}{
	...
	(*Locality)(nil),              // 2: registryv2.Locality
	(*MemberState)(nil),           // 3: registryv2.MemberState
	(*MonotonicTimestamp)(nil),    // 4: registryv2.MonotonicTimestamp
	(*Version2)(nil),              // 5: registryv2.Version2
	(*Member2)(nil),               // 6: registryv2.Member2
	(*UpdateRequest)(nil),         // 7: registryv2.UpdateRequest
	(*UpdateResponse)(nil),        // 8: registryv2.UpdateResponse
	(*ReplicaSyncRequest)(nil),    // 9: registryv2.ReplicaSyncRequest
	(*ReplicaSyncResponse)(nil),   // 10: registryv2.ReplicaSyncResponse
	(*ClientFilter)(nil),          // 11: registryv2.ClientFilter
	(*ClientSyncRequest)(nil),     // 12: registryv2.ClientSyncRequest
...
func file_registryv2_proto_init() {
	...
	file_registryv2_proto_msgTypes[12].OneofWrappers = []interface{}{}
	type x struct{}
