...
var file_registry_proto_rawDesc = []byte{
	...
	0x41, 0x54, 0x10, 0x02, 0x32, 0x90, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72,
	0x79, 0x12, 0x47, 0x0a, 0x09, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x1a,
	0x2e, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72,
	0x69, 0x62, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x72, 0x65, 0x67,
	0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x4d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x08, 0x52, 0x65,
	...
	0x41, 0x63, 0x6b, 0x28, 0x01, 0x30, 0x01, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_registry_proto_goTypes = []interface{}{
	...
	(*Version)(nil),            // 2: registry.Version
	(*Member)(nil),             // 3: registry.Member
	...
	nil,                        // 9: registry.Member.MetadataEntry
	nil,                        // 10: registry.SubscribeRequest.KnownMembersEntry
}
var file_registry_proto_depIdxs = []int32{
	9,  // 0: registry.Member.metadata:type_name -> registry.Member.MetadataEntry
	0,  // 1: registry.LocalMemberUpdate.update_type:type_name -> registry.MemberUpdateType
	3,  // 2: registry.LocalMemberUpdate.member:type_name -> registry.Member
	0,  // 3: registry.RemoteMemberUpdate.update_type:type_name -> registry.MemberUpdateType
	3,  // 4: registry.RemoteMemberUpdate.member:type_name -> registry.Member
	2,  // 5: registry.RemoteMemberUpdate.version:type_name -> registry.Version
	10, // 6: registry.SubscribeRequest.known_members:type_name -> registry.SubscribeRequest.KnownMembersEntry
	1,  // 7: registry.ClientUpdate.update_type:type_name -> registry.ClientUpdateType
	3,  // 8: registry.ClientUpdate.member:type_name -> registry.Member
	2,  // 9: registry.SubscribeRequest.KnownMembersEntry.value:type_name -> registry.Version
	6,  // 10: registry.Registry.Subscribe:input_type -> registry.SubscribeRequest
	7,  // 11: registry.Registry.Register:input_type -> registry.ClientUpdate
	5,  // 12: registry.Registry.Subscribe:output_type -> registry.RemoteMemberUpdate
	8,  // 13: registry.Registry.Register:output_type -> registry.ClientAck
